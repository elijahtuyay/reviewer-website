...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- reads the DOM class set by the pre-hydration ThemeInitScript, unavailable during render/SSR
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 items-center justify-center rounded-md border border-line-strong text-muted transition-[color,background-color,transform] hover:bg-panel-hover hover:text-foreground active:scale-95"
    >
      {isDark ? (
